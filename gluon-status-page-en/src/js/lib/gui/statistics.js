...
define(["lib/helper"], function (Helper) {
  ...
  return function (stream) {
    ...
    children.push(mkRow(table, "CPU-Usage", stream.map(".loadavg").map(prettyLoad)))
    ...
    mkTrafficRow(table, children, "Sent", stream, ".traffic.tx")
    mkTrafficRow(table, children, "Received", stream, ".traffic.rx")
    mkTrafficRow(table, children, "Transferred", stream, ".traffic.forward")
